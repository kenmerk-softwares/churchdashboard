...
export const PageVisitsTable = ({ pageVisits }) => {
  const TableRow = (props) => {
    ...
    return (
      <Draggable draggableId={pageName} index={props.index}>
        {(provided) => (
          <tr
  ...
  return (
    <Card border="light" className="shadow-sm">
      ...
      <DragDropContext onDragEnd={onDragEnd}>
        <Droppable droppableId="pageVisits">
          {(provided) => (
            <Table
              responsive
...
export const TransactionsTable = () => {
  ...
  const TableRow = (props) => {
    ...
    return (
      <tr>
        <td>
          <Card.Link as={Link} to={Pathname.Invoice.path} className="fw-normal">
            {invoiceNumber}
          </Card.Link>
        </td>
        <td>
