...
export const ProfileCardWidget = ({ userInfo }) => {
  return (
    <Card border="light" className="text-center p-0 mb-4">
      <div style={{ backgroundImage: `url(${ProfileCover})` }} className="profile-cover rounded-top" />
      <Card.Body className="pb-5">
        <Card.Img src={userInfo.photoURL?userInfo.photoURL:Profile1} alt="Neil Portrait" className="user-avatar large-avatar rounded-circle mx-auto mt-n7 mb-4" />
        <Card.Title>{userInfo.displayName?userInfo.displayName:userInfo.email}</Card.Title>
...
export const ChoosePhotoWidget = (props,{ userInfo }) => {
      ...
      <Card.Body>
        ...
        <div className="d-xl-flex align-items-center">
          <div className="user-avatar xl-avatar">
            <Image fluid rounded src={userInfo?userInfo.photoURL:photo} />
          </div>
